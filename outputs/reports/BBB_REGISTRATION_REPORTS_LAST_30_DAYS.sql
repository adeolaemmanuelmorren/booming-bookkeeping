...
-- Rolling window: today plus the preceding 29 Pacific calendar dates.

DECLARE report_end_date DATE DEFAULT CURRENT_DATE('America/Los_Angeles');
DECLARE report_start_date DATE DEFAULT DATE_SUB(report_end_date, INTERVAL 29 DAY);
