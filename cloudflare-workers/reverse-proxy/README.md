...
attribution-enrichment layer, and browser purchase-confirmation service for the
Boom Bookkeeping funnel.

The approved V1 design is documented in [JITSU_CLOUD_PROXY_MIGRATION.md](JITSU_CLOUD_PROXY_MIGRATION.md). The deferred Cookiebot and consent design is documented separately in [JITSU_COOKIEBOT_CONSENT_V2.md](JITSU_COOKIEBOT_CONSENT_V2.md).
