/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6395d89c8ee70ef492987d9bc1b8023e)
// Runtime types generated with workerd@1.20260424.1 2026-04-25 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PurchaseState" | "ConsentShard";
	}
	interface Env {
		JITSU_CLOUD_HOST: "https://cmrq0k1lw00003b7wngvf3goe.d.jitsu.com";
		JITSU_WRITE_KEY: string;
		PURCHASE_STATE: DurableObjectNamespace<import("./src/index").PurchaseState>;
		CONSENT_SHARD: DurableObjectNamespace<import("./src/index").ConsentShard>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JITSU_CLOUD_HOST" | "JITSU_WRITE_KEY">> {}
}
