/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3d9db01b4690f6ff80fd991f0ab91102)
// Runtime types generated with workerd@1.20260424.1 2026-04-25 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ReverseEtlDebugStore";
	}
	interface Env {
		DLQ_KV: KVNamespace;
		WEBHOOK_QUEUE: Queue;
		DLQ_QUEUE: Queue;
		ACTIVE_CAMPAIGN_SEGMENT_ANONYMOUS_ID_FIELD_IDS: "39";
		SEGMENT_API_URL: "https://api.segment.io";
		REVERSE_ETL_DEBUG_STORE: DurableObjectNamespace<import("./src/index").ReverseEtlDebugStore>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACTIVE_CAMPAIGN_SEGMENT_ANONYMOUS_ID_FIELD_IDS" | "SEGMENT_API_URL">> {}
}
