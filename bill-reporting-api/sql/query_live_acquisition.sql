...
SELECT
  ...
  reporting.adset_id,
  reporting.ad_id,
  reporting.campaign_name,
  reporting.adset_name,
  reporting.ad_name,
  reporting.spend,
  reporting.impressions,
  reporting.clicks,
  reporting.last_touch_registrations,
  reporting.last_touch_immediate_vips,
  reporting.first_touch_registrations,
  reporting.first_touch_immediate_vips,
  reporting.solo_touch_registrations,
  reporting.solo_touch_immediate_vips
